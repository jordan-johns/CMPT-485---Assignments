...
#include "../GL3/gl3.h"
#include "glprogram.h"
#include "../RayTracing/rayshader.h"

namespace Shader
{

class Shader : public RayTracing::Shader
{
protected:
...
public:
	...
	// RayTracer::Shader::shade()
	//   calculate the color of a light from a given direction
	//   Default (unimplemented) returns white
	virtual gml::vec3_t shade(const RayTracing::ShaderValues &vals) const;
};
